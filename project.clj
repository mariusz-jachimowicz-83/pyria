(defproject pyria "0.1.0-SNAPSHOT"
  :description "Pyria - procurement system"
  ...
  :uberjar-name "pyria.jar"

  ;; Use `lein run` if you just want to start a HTTP server, without figwheel
  :main pyria.application
  ...
  :cljsbuild {:builds
              [{:id "app"
                ...
                :figwheel {:on-jsload "pyria.system/reset"}
               ...
               {:id "test"
                ...
                :compiler {:output-to "resources/public/js/compiled/testable.js"
                           :main pyria.test-runner
                           :optimizations :none}}

               {:id "min"
                :source-paths ["src/cljs" "src/cljc"]
                :jar true
                :compiler {:main pyria.system
                           :output-to "resources/public/js/compiled/pyria.js"
                           :output-dir "target"
                           :source-map-timestamp true
